...
import cn.bugstack.ai.test.TestImageResource;
...
public class ChatServiceTest {
    ...
    public void test_handleMessage_04_withImage() throws IOException {
        ...
        ChatCommandEntity chatCommandEntity = ChatCommandEntity.builder()
                ...
                .files(List.of())
                .inlineDatas(List.of(new ChatCommandEntity.Content.InlineData(TestImageResource.dog().getContentAsByteArray(), MimeTypeUtils.IMAGE_PNG_VALUE)))
                .build();
